# GCP実務ナビ - スケジュールエージェントガイド

このリポジトリは **GCP（治験基準）** の実務情報を発信するブログ `GCP実務ナビ` の本体です。
あなた（スケジュールエージェント）は毎日JST 03:30に起動し、最新ネタをリサーチして記事を **2本** 生成します。

## 1日のタスク

1. **リサーチ**: WebSearch / WebFetch で ICH-GCP/治験モニタリング/SDV/RBM/同意取得/PMDA・FDA査察対応 に関する最新トピック2件を収集
   - 候補例: ICH-GCP E6(R3) の実務ポイント／RBM（リスクベースドモニタリング）導入ステップ／SDV判定の実務基準／ICF（同意説明文書）作成チェックリスト／PMDA査察の事前準備
...
<title>{{記事タイトル}} | GCP実務ナビ</title>
<meta name="description" content="{{150字以内の要約}}">
<link rel="canonical" href="https://pharmaworkerka.github.io/gcp-navi/articles/{{slug}}.html">
<meta property="og:type" content="article">
<meta property="og:title" content="{{タイトル}}">
<meta property="og:description" content="{{要約}}">
<meta property="og:image" content="{{Unsplash画像URL}}">
<meta property="og:url" content="https://pharmaworkerka.github.io/gcp-navi/articles/{{slug}}.html">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image" content="{{Unsplash画像URL}}">
<script type="application/ld+json">{{"@context":"https://schema.org","@type":"Article","headline":"{{タイトル}}","image":"{{Unsplash}}","datePublished":"{{YYYY-MM-DD}}","author":{{"@type":"Organization","name":"GCP実務ナビ"}}}}</script>
...
<p class="copyright">© 2026 GCP実務ナビ</p>
</div></footer>
</body></html>
```
...
```xml
<url>
  <loc>https://pharmaworkerka.github.io/gcp-navi/articles/{{slug}}.html</loc>
  <lastmod>{{今日}}</lastmod>
